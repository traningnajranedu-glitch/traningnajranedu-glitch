...
export default function ExamPage(){
 ...
 useEffect(()=>{if(!result)return;const t=setTimeout(()=>{try{window.close();}catch{}},5000);return()=>clearTimeout(t)},[result]);
 if(result){
  return <main className="examScreen nationalDayScreen" dir="rtl"><div className="nationalDayGlow nationalDayGlowOne"></div><div className="nationalDayGlow nationalDayGlowTwo"></div><div className="examCard nationalDayCard resultCard"><div className="nationalDayBanner"><div className="nationalDayPattern"></div><div className="nationalDayBadge"><span>96</span><small>اليوم الوطني</small></div><div className="nationalDayBannerText"><strong>اليوم الوطني السعودي 96</strong><span>عزّنا بطبعنا</span></div></div><div className="examLogo nationalExamLogo"><span>✓</span><b>🇸🇦</b></div><div className="nationalDayTitle"><span className="eyebrow">تم استلام الاختبار</span><h1>شكرًا لك، تم تسليم الاختبار بنجاح</h1><p>تم استلام إجاباتك وتسجيل مشاركتك في الاختبار.</p></div><div className="loginWelcome"><div className="loginWelcomeIcon">✓</div><div><strong>نتمنى لك التوفيق والنجاح</strong><span>شكرًا لمشاركتك، ونسأل الله لك دوام التوفيق والنجاح في مسيرتك.</span></div></div><div className="nationalDayValues"><span>🇸🇦 فخر واعتزاز</span><span>•</span><span>96 عامًا من المجد</span><span>•</span><span>عزّنا بطبعنا</span></div><div className="nationalDayFooter"><span>سيتم إغلاق الصفحة تلقائيًا خلال 5 ثوانٍ</span></div></div></main>;
 }
